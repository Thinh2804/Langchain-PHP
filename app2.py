...
def answer():
    ...
    # Gọi hàm để trả lời câu hỏi
    answer, sources = answer_question_in_vietnamese(question)
    
    # Chuyển đổi nguồn tham khảo thành định dạng phù hợp
    formatted_sources = [{"source": source, "page": list(pages)} for source, pages in sources.items()]
